...
public partial class Adm1
{
    ...
    public string? MtdlbltAct { get; set; }

    public string? MtdclmAct { get; set; }

    public string? RmrksIncld { get; set; }

    public string? VerfVatNo { get; set; }

    public int? VerfVatMxD { get; set; }

    public string? VerfVatAct { get; set; }

    public string? CnpjofIt { get; set; }
    ...
    public string? IsuseDscSv { get; set; }

    public string? UrlRegSrv { get; set; }

    public int? ElSersReg { get; set; }

    public int? ElsersCncl { get; set; }

    public int? ElsersFin { get; set; }

    public string? EnbEaser { get; set; }

    public int? IntrFlines { get; set; }
}
