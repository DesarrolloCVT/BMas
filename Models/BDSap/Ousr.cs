...
public partial class Ousr
{
    ...
    public short InternalK { get; set; }
    ...
    public string? ShowLicBal { get; set; }

    public DateTime? LicBaHdate { get; set; }

    public string? AttachChb { get; set; }

    public string? ULlUser { get; set; }

    public string? ULlPassword { get; set; }

    public string? ULlAdm { get; set; }

    public string? UTipoUsuario { get; set; }
    ...
    public string? UExxVentanaDefecto { get; set; }
