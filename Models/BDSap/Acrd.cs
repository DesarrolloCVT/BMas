...
public partial class Acrd
{
    ...
    public string? USiglaLote { get; set; }

    public string? UTipo { get; set; }

    public string? UExcluir { get; set; }

    public string? UNxValidForPdte { get; set; }

    public string? UNxRecurrentePdte { get; set; }

    public string? UNxArtSerPdte { get; set; }

    public string? UNxArtDflt { get; set; }
    ...
    public string UExxSnPos { get; set; } = null!;

    public string? UExxGiro { get; set; }

    public string UX4rListapreciosn { get; set; } = null!;

    public DateTime? ULcInicio { get; set; }

    public DateTime? ULcTermino { get; set; }

    public string? UComentSeguro { get; set; }
}
