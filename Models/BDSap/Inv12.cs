...
public partial class Inv12
{
    ...
    public DateTime? TransprtDt { get; set; }
    ...
    public DateTime? ImpExpDate { get; set; }
    ...
    public DateTime? OrigImpDat { get; set; }
    ...
    public DateTime? DptDateGip { get; set; }
    ...
    public DateTime? DpDtDlvryP { get; set; }
