...
public partial class Oitm
{
    ...
    public string? UItemCodeRep { get; set; }

    public string? UItemCodeDes { get; set; }

    public string? UItemCodeUnidad { get; set; }

    public int? UCantMinimaProd { get; set; }

    public string? UTipoProd { get; set; }

    public string? UVariedad { get; set; }

    public int? UDiasVidaUtil { get; set; }

    public int? UMetaProduccionOf { get; set; }
    ...
    public string? USubGrupo { get; set; }

    public string? UDescripcionAlt { get; set; }

    public string? USubFamilia { get; set; }

    public string? UDistribucion { get; set; }
    ...
    public int? UAceptacionRecep { get; set; }

    public int? UMultiplo { get; set; }

    public int? UVentaMinima { get; set; }

    public string? UVentaPorMultiplo { get; set; }

    public string? UVentaPorMinima { get; set; }

    public int? UPpalletCompleto { get; set; }

    public int? UPpalletBase { get; set; }
}
