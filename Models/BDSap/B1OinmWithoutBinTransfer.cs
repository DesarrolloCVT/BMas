...
public partial class B1OinmWithoutBinTransfer
{
    ...
    public decimal? InvPlinQty { get; set; }

    public decimal? InvPloutQty { get; set; }

    public decimal? InvPlprice { get; set; }

    public string? InvPlcurrency { get; set; }

    public decimal? InvPlrate { get; set; }

    public int InvPllayerId { get; set; }

    public int InvPlmessageId { get; set; }

    public int? InvPlsubLineNum { get; set; }
