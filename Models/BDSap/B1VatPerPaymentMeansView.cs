...
public partial class B1VatPerPaymentMeansView
{
    ...
    public string DocLineType { get; set; } = null!;
    ...
    public int? PaidDocAbsEntry { get; set; }

    public int? PayObjType { get; set; }
